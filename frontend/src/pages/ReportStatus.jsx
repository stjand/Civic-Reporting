...
import { CheckCircle, Clock, MapPin, User, FileText, Loader2, ArrowLeft, Shield } from 'lucide-react'
            ...
            <div className="flex items-center justify-between h-16">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="font-semibold text-lg text-gray-900">Report Status</span>
                </div>
              </div>
            </div>
          </div>
